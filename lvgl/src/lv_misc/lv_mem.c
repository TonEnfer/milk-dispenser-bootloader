...
DMA_BUFFER   static uint8_t mem_buf1_32[MEM_BUF_SMALL_SIZE];
DMA_BUFFER   static uint8_t mem_buf2_32[MEM_BUF_SMALL_SIZE];
...
void _lv_mem_init(void)
{
	...
	DMA_BUFFER  static LV_MEM_ATTR MEM_UNIT work_mem_int[LV_MEM_SIZE / sizeof(MEM_UNIT)];
